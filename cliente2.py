...
if __name__ == "__main__":
    ...
    if torrent_path:
        ...
        threading.Thread(target=iniciar_cliente, args=('127.0.0.1', 6884)).start()

        # Registrar torrent en el tracker
        response = registrar_torrent('127.0.0.1', 6881, torrent_id, '127.0.0.1', 6884)
        print(response)
        ...
        descargar_archivo(torrent_id, '127.0.0.1', 6881, '127.0.0.1', 6884, num_pieces)
    else:
